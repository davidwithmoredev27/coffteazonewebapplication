        ...
        if (isset($_POST['btnservicesbtn'])) {
            if (isset($_FILES['roomimg'])) {
                ...
                if (mysqli_num_rows($result) == 5) {
                    mysqli_close($connection);
                    $_SESSION['error'] = "<span><strong class=\"white-text\">The maximum image for package two is 5!</strong></span>\n";
                    header("location:martinasservices.php");
                }
            ...
            if (isset($_SESSION['confirmuploadstatus'])) {
                ...
                $sql= "INSERT INTO tbl_services_martinas_package2(path) VALUES('$path')";
