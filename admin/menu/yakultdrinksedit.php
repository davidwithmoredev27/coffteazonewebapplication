...
<?php
    ...
    $_SESSION['menuid'] = 7;
    $_SESSION['menupath'] = "img/menu/drinks/yakultdrinks/";
    $_SESSION['database_name'] = "tbl_menu_yakultdrinks";
    $_SESSION['pagelink'] = "yakultdrinks.php";
    $_SESSION['pagename'] = "Yakult Drinks";
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if (isset($_POST['menuedit'])) {
            ...
            if (isset($_POST['menueditid'])) {
             ...
             $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">Select and ".$_SESSION['pagname'] . " id!</strong></span>\n";
             header("location:". $_SESSION['pagelink']);
                die();
        }
    } else {
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="yakultdrinks.php" class="breadcrumb">Yakult Drinks</a>
                ...
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                     <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" autocomplete="off" id="menuconfirmtitle" name="menuconfirmtitle" maxlength="50" data-length="50" required class="validate">
                                <label for="menuconfirmtitle">Title</label>
                            </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <textarea data-length="100" maxlength="100" id="menuconfirmcaption" autocomplete="off" required name="menuconfirmcaption" class="materialize-textarea"></textarea>
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST"  action="menuuploadconfirm.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" autocomplete="off" id="title" name="menuconfirmtitle" data-length="50" maxlength = "50" required class="validate">
                                <label for="title">Title</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="100" data-length="100" autocomplete="off" required id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
