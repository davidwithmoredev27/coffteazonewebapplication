...
<?php
    ...
    $_SESSION['pagemessage'] = "Yakult drinks";
        ...
        if (isset($_POST['menuedit'])) {
            ...
            if (isset($_POST['menueditid'])) {
                ...
                if (is_numeric($_POST['menueditid'])){
                    ...
                    $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">Enter valid ".$_SESSION['pagemessage']." id!</strong></span>\n";
                    header("location:". $_SESSION['pagelink']);
                    die();
                }  
            } else {
                $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">Select an". $_SESSION['pagemessage'] ." id!</strong></span>\n";
                    header("location:". $_SESSION['pagelink']);
                    die();
            }
        } else {
             $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">Select and ".$_SESSION['pagemessage']." id!</strong></span>\n";
             header("location:". $_SESSION['pagelink']);
                die();
        }
    } else {
...
<head>
    ...
    <title>Admin <?php echo $_SESSION['pagemessage']; ?> edit</title>
