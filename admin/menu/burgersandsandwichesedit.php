...
<?php
    ...
    $_SESSION['menuid'] = 12; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/foods/burgersandsandwiches/";
    $_SESSION['database_name'] = "tbl_menu_burgerandsandwiches";
    $_SESSION['pagelink'] = "burgersandsandwiches.php";
    $_SESSION['pagename'] = "Burgers and Sandwiches";
    $_SESSION['pagemessage'] = "Burger And sandwiches";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="../foods.php" class="breadcrumb">Fodds</a>
                            <a href="burgersandsandwiches.php" class="breadcrumb">Burgers And Sandwiches</a>
            ...
            <div class="container">
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="100" data-length="100" autocomplete="off" maxlength="500" id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
