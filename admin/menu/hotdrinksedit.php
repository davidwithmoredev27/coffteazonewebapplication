...
<?php
    ...
    $_SESSION['menuid'] = 4;
    $_SESSION['menupath'] = "img/menu/drinks/hotdrinks/";
    $_SESSION['database_name'] = "tbl_menu_hotdrinks";
    $_SESSION['pagelink'] = "hotdrinks.php";
    $_SESSION['pagename'] = "Hot Drinks";
...
<body>
    <header class="headerstyle">
        ...
        <ul id="slide-out" class="side-nav admincolor fixed  sidenavstyle">
            ...
            <li class="logostyle">
                <a href="../dashboard.php" class="center-align"><img src="../../img/logo/cofftealogo.png" width="80px" height="80px"></a>
            </li>
            <li>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="hotdrinks.php" class="breadcrumb">Hot Drinks</a>
                    ...
                    <div class="row">
                        <div class="file-field input-field col s12 m12 l12 xl12">
                             <div class="btn blue-grey darken-4">
                                <span>Image</span>
                                <input type="file"  name="menuconfirmimg" required>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="100" data-length="100" required autocomplete="off" id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
