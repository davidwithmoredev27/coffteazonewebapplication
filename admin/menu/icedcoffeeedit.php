...
<?php
    ...
    $_SESSION['menuid'] = 5;
    $_SESSION['menupath'] = "img/menu/drinks/icedcoffee/";
    $_SESSION['database_name'] = "tbl_menu_icedcoffee";
    $_SESSION['pagelink'] = "icedcoffee.php";
    $_SESSION['pagename'] = "Iced Coffee";
    ...
    <header class="headerstyle">
        ...
        <nav>
            <div class="nav-wrapper adminnavbar admincolor">
                <a href="#" class="brand-logo center-align brand-logomobile"><img src="../../img/logo/cofftealogo.png" width="100px" heigth="100px" alt=""></a>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="icedcoffee.php" class="breadcrumb">Iced Coffee</a>
                ...
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                     <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <input type="text" class="center-align" autocomplete="off" id="menuconfirmtitle" name="menuconfirmtitle" maxlength="50" datalength="50" required class="validate">
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="100" autocomplete="off" data-length="100" required id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
