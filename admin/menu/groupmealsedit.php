...
<?php
    ...
    $_SESSION['menuid'] = 16; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/foods/groupmeals/";
    $_SESSION['database_name'] = "tbl_menu_groupmeals";
    $_SESSION['pagelink'] = "groupmeals.php";
    $_SESSION['pagename'] = "Group Meals";
                                            ...
                                            <div class="collapsible-body admincolor">
                                                <ul>
                                                    <li>
                                                     ...
                                                     <li>
                                                         <a href="../dessert.php" class="white-text left-align indent">Desserts
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="groupmeals.php" class="breadcrumb">Group Meals</a>
        ...
        <div class="container slidereditshowmobile">
            ...
            <div class="row">
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <textarea data-length="100" id="menuconfirmcaption" autocomplete="off" required maxlength="100" name="menuconfirmcaption" class="materialize-textarea"></textarea>
