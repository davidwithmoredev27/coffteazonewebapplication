...
<?php 
    ...
    $_SESSION['menuid'] = 6; // signaturedrinks
    ...
    $_SESSION['editpage'] = "frapuccinoedit.php";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m12 xl12 m12">
                    <h4 class="center-align"><?php echo $_SESSION['pagename'];?> Menu Settings</h4>
                </div>
                <?php 
                        ...
                        <form class="col s12 m12 l12 xl12" method="POST" enctype="multipart/form-data" action="menuupload.php">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12">
                                    <input type="text" id="menutitle" class="center-align" autocomplete="off" data-length="50" name="menutitle" maxlength="50" required class="validate">
                                    <label for="menutitle">Title</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12">
                                    <textarea id="textarea1" data-length="100" maxlength="100"  autocomplete="off" name="menucaption" class="materialize-textarea"></textarea>
