...
<?php
    ...
    $_SESSION['menuid'] = 19; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/dessert/cakes/";
    $_SESSION['database_name'] = "tbl_menu_cakes";
    $_SESSION['pagelink'] = "cakes.php";
    $_SESSION['pagename'] = "Cakes";
                ...
                if (filter_var($_POST['menueditid'], FILTER_VALIDATE_INT)){
                    ...
                    $result = mysqli_query($connection , $sql);
                     if (mysqli_num_rows($result) <= 0) {
                        ...
                        $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">".$_SESSION['pagname'] ." id is not available!</strong></span>\n";
                    ...
                    $_SESSION['menuuploaderror'] = "<span><strong class=\"white-text\">Enter valid ".$_SESSION['pagname'] ." id!</strong></span>\n";
                    header("location:". $_SESSION['pagelink']);
                    die();
                }  
            } else {
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="../dessert.php" class="breadcrumb">Dessert</a>
                            <a href="burgersandsandwiches.php" class="breadcrumb">Cakes</a>
        ...
        <div class="container slidereditshowmobile">
            ...
            <div class="row">
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <textarea data-length="50" maxlength="50" id="menuconfirmcaption" autocomplete="off" required name="menuconfirmcaption" class="materialize-textarea"></textarea>
