                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="cakes.php" class="breadcrumb">Cakes</a>
            ...
            <div class="container">
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea data-length="100" autocomplete="off" id="menuconfirmcaption" maxlength="500"  name="menuconfirmcaption" class="materialize-textarea"></textarea>
            ...
            <div class="container">
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="500" data-length="500" autocomplete="off" maxlength="500" id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
