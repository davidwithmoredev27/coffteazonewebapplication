...
<?php
    ...
    $_SESSION['menuid'] = 20; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/dessert/muffins/";
    $_SESSION['database_name'] = "tbl_menu_muffins";
    $_SESSION['pagelink'] = "muffins.php";
    $_SESSION['pagename'] = "Muffins";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="muffins.php" class="breadcrumb">Muffins</a>
