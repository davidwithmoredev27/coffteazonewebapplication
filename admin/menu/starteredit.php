...
<?php
    ...
    $_SESSION['menuid'] = 11; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/foods/starter/";
    $_SESSION['database_name'] = "tbl_menu_starter";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="starter.php" class="breadcrumb">Starter</a>
                ...
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                     <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" autocomplete="off" id="menuconfirmtitle" name="menuconfirmtitle" data-length="50" maxlength="50" required class="validate">
