...
<?php
    ...
    $_SESSION['menuid'] = 6;
    $_SESSION['menupath'] = "img/menu/drinks/frapuccino/";
    $_SESSION['database_name'] = "tbl_menu_frapuccino";
    $_SESSION['pagelink'] = "frapuccino.php";
    $_SESSION['pagename'] = "Frapuccino";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="frapuccino.php" class="breadcrumb">Frapuccino</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" autocomplete="off" id="title" name="menuconfirmtitle" maxlength= "50" data-length="50" required class="validate">
