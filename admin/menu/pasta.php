...
<?php 
    ...
    $_SESSION['editpage'] = "pastaedit.php";
...
<body>
    <header class="headerstyle">
        ...
        <ul id="slide-out" class="side-nav admincolor fixed  sidenavstyle">
            ...
            <li class="logostyle">
                <a href="../dashboard.php" class="center-align"><img  src="../../img/logo/cofftealogo.png" width="100px" heigth="100px"></a>
            </li>
            <li>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Pasta</a>
                        </div>
                    </div>
                </nav>
            </div>
