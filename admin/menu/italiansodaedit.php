...
<?php
    ...
    $_SESSION['menuid'] = 2;
    $_SESSION['menupath'] = "img/menu/drinks/italiansoda/";
    $_SESSION['database_name'] = "tbl_menu_italliansoda";
    $_SESSION['pagelink'] = "italiansoda.php";
    $_SESSION['pagename'] = "Italian Soda";
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="100" data-length="100" autocomplete="off" id="menuconfirmcaption" required name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
