...
<?php
    ...
    $_SESSION['menuid'] = 15;
    $_SESSION['menupath'] = "img/menu/foods/maincourse/";
    $_SESSION['database_name'] = "tbl_menu_maincourse";
    $_SESSION['pagelink'] = "maincourse.php";
    $_SESSION['pagename'] = "Main Course";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="maincorse.php" class="breadcrumb">Main Course</a>
