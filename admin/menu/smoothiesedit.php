...
<?php
    ...
    $_SESSION['menuid'] = 9; // signaturedrinks
                ...
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                     <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" id="menuconfirmtitle" autocomplete="off" name="menuconfirmtitle" maxlength="100" data-length="100" required class="validate">
                                <label for="menuconfirmtitle">Title</label>
                            </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <textarea maxlength="1000" data-length="1000" id="menuconfirmcaption" autocomplete="off" required name="menuconfirmcaption" class="materialize-textarea"></textarea>
                    ...
                    <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <div class="row">
                                    <button type="submit" name="menusubtmiconfirm"  class="btn waves-light waves-effect brown darken-3 col s12 l5 m5 offset-m3 xl5 offset-xl3">Change</button>
                                </div>
                            </div>
                        </div>
                </form>
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea data-length="100" maxlength="100" required  autocomplete="off" id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
