...
<?php
    ...
    $_SESSION['menuid'] = 13; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/foods/pizza/";
    $_SESSION['database_name'] = "tbl_menu_pizza";
    $_SESSION['pagelink'] = "pizza.php";
    $_SESSION['pagename'] = "Pizza";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="pizza.php" class="breadcrumb">Pizza</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" id="title" autocomplete="off" name="menuconfirmtitle" maxlength= "50" required class="validate">
