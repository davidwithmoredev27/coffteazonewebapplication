                ...
                <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                     <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" autocomplete="off" class="center-align" id="menuconfirmtitle" name="menuconfirmtitle" maxlength="50" data-length="50" required class="validate">
                                <label for="menuconfirmtitle">Title</label>
                            </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <textarea data-length="100" autocomplete="off" maxlength="100" id="menuconfirmcaption" required name="menuconfirmcaption" class="materialize-textarea"></textarea>
                            <label for="menuconfirmcaption">Caption</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12 xl12">
                            <input type="text" autocomplete="off" class="center-align" required name="menupriceconfirm" id="menupriceconfirm">   
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="col s12 m12 l12 xl12" method="POST" action="menuuploadconfirm.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" autocomplete="off" class="center-align" id="title" name="menuconfirmtitle" data-length="50" maxlength= "50" required class="validate">
                                <label for="title">Title</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea maxlength="1000" autocomplete="off" data-length="100" required id="menuconfirmcaption" name="menuconfirmcaption" class="materialize-textarea"></textarea>
                                <label for="menuconfirmcaption">Caption</label>
                            </div>
                        </div>
                        <div class="row">
