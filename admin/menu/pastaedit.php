...
<?php
    ...
    $_SESSION['menuid'] = 18; // signaturedrinks
    $_SESSION['menupath'] = "img/menu/foods/pasta/";
    $_SESSION['database_name'] = "tbl_menu_pasta";
    $_SESSION['pagelink'] = "pasta.php";
    $_SESSION['pagename'] = "Pasta";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="pasta.php" class="breadcrumb">Pasta</a>
