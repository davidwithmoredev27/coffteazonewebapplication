...
<?php 
    ...
    $_SESSION['editpage'] = "muffinsedit.php";
...
<body>
    <header class="headerstyle">
        ...
        <ul id="slide-out" class="side-nav admincolor fixed  sidenavstyle">
            ...
            <li class="logostyle">
                <a href="../dashboard.php" class="center-align"><img class="logo-brand" src="../../img/logo/cofftealogo.png" width="80px" heigth="80px"></a>
            </li>
            <li>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Muffins</a>
                        </div>
                    </div>
                </nav>
            </div>
                        ...
                        <form class="col s12 m12 l12 xl12" method="POST" enctype="multipart/form-data" action="menuupload.php">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12">
                                    <input type="text" id="menutitle" autocomplete="off" class="center-align" name="menutitle" data-length="50" maxlength="50" required class="validate">
                                    <label for="menutitle">Title</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12">
                                    <textarea id="textarea1"  autocomplete="off" maxlength="100" data-length="100"  name="menucaption" class="materialize-textarea"></textarea>
