...
<?php 
    ...
    $_SESSION['menuid'] = 5; // signaturedrinks
    ...
    $_SESSION['editpage'] = "icedcoffeeedit.php";
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Iced Coffee</a>
                        </div>
                    </div>
                </nav>
            </div>
                        ...
                        <form class="col s12 m12 l12 xl12" method="POST" enctype="multipart/form-data" action="menuupload.php">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12">
                                    <input type="text" id="menutitle" autocomplete="off" class="center-align" name="menutitle" maxlength="50" maxlength="50" required class="validate">
