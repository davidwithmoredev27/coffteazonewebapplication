...
<head>
    ...
    <title>Drinks Category Settings</title>
            ...
            <div class="col s12 m12 l10 xl10">
                <div class="row">
                    <div class="col s10 m10 l2 xl2 offset-s1 offset-m1 boxcolor z-depth-3">
                        <div class="row">
                            <h6 class="col s12 m12 xl12 l12 white-text center-align">Cakes</h6>
                        </div>
                        <div class="row">
                                <a href="../admin/menu/cakes.php" class="btn waves-light waves-effect col btncolor  offset-xl3 offset-l3 offset-s3 offset-m3 s6 m6 xl6 l6 white-text center-align">Edit</a>
                        </div>
                    </div>
                    ...
                    <div class="col s10 m10 l2 xl2 offset-s1 offset-m1 offset-l1 offset-xl1  boxcolor z-depth-3">
                        <div class="row">
                            <h6 class="col s12 m12 xl12 l12 white-text center-align">Muffins</h6>
                        </div>
                        <div class="row">
                                <a href="../admin/menu/muffins.php" class="btn waves-light waves-effect col btncolor offset-xl3 offset-l3 offset-s3 offset-m3 s6 m6 xl6 l6 white-text center-align">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
