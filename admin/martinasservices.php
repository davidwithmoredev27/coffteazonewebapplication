...
<head>
    ...
    <title>Admin | Martinas Services</title>
    ...
    <main>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <div class="row">
                    <div class="col s12 m12 l12 xl12">
                        <h5 class="center-align">Martinas Services</h5>
                    </div>
                </div>
            </div>
            <div class="col s12 m12 l12 xl12">
                ...
                <div class="col s12 m12 l12 xl12 willshowdesktop">
                    <div class="row">
                        ...
                        <div class="col s12 m12 xl4 l4">
                            <div class="row">
                                <div class="col s12 m12 l12 xl12"><h6 class="center-align">Add package one image.</h6></div>
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12"></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col s12 m12 l12 xl12">
                                    <div class="row">
                                        <form action="packageuploadone.php" class="col s12 m12 l12 xl12" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                         ...
                         <div class="col s12 m12 xl8 l8">
                            <div class="row">
                                <div class="col s12 m12 l12 xl12">
                                    <div class="row">
                                        <div class="col s12 m12 l12 xl12">
                                            <h6 class="center-align">Package one images</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                                        ...
                                                        if (mysqli_num_rows($result) > 0) {
                                                            while ($rows = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo "<td class=\"center-align\">\n".
                                                                        "<form method=\"POST\" action=\"packageonedelete.php\">\n".
                                                                            "<input type=\"hidden\" name=\"packagedelete\" value=\"".$rows['id']."\">\n".
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m12 xl4 l4">
                            <div class="row">
                                ...
                                <div class="col s12 m12 l12 xl12"><h6 class="center-align">Add package two image.</h6></div>
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12"></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col s12 m12 l12 xl12">
                                    <div class="row">
                                        <form action="packageuploadtwo.php" class="col s12 m12 l12 xl12" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="file-field input-field">
                                                    <div class="btn">
                                                        <span>File</span>
                         ...
                         <div class="col s12 m12 xl8 l8">
                            <div class="row">
                                <div class="col s12 m12 l12 xl12">
                                    <div class="row">
                                        <div class="col s12 m12 l12 xl12">
                                            <h6 class="center-align">Packages two images</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m12 xl12 l12">
                                            <table class="responsive-table bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM tbl_services_martinas_package2";
                                                        $result = mysqli_query($connection , $sql);
                                                        $counter = 1;
                                                        if (mysqli_num_rows($result) > 0) {
                                                            while ($rows = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo "<td class=\"center-align\"><img src=\"../".$rows['path']."\" width=\"50px\" height=\"75px\"></td>\n";
                                                                echo "<td class=\"center-align\">\n".
                                                                        "<form method=\"POST\" action=\"packagetwodelete.php\">\n".
                                                                            "<input type=\"hidden\" name=\"packagedelete\" value=\"".$rows['id']."\">\n".
                                                                            "<button type=\"submit\" name=\"btndelete\" class=\"delete btn waves-light waves-effect red darken-3\">Delete</button>\n".
                                                                        "</form>\n".
                                                                    "</td>\n";
                         ...
                         <div class="col s12 m12 xl12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12 xl12">
                                    <div class="row">
                                        <div class="col s12 m12 l12 xl12">
                                            <h6 class="center-align">Package two images</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m12 xl12 l12">
