         ...
         if (isset($_POST['username']) && !empty($_POST['username'])) {
            ...
            if (mysqli_num_rows($resultQuery) > 0) {
                ...
                if (!isset($userCredentials['username'])) {
                    header("location: usernameerr.php");
                    die();
                }
            }
        } 
        ...
        if (isset($_POST['password']) && !empty($_POST['password'])) {
            ...
            if (mysqli_num_rows($resultQuery) > 0) {
                ...
                if (!isset($userCredentials['password'])) {
                    header("location: passworderr.php");
                    die();
                }
            }
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m6 offset-m3 l6 offset-l3 xl6 offset-xl3 card-panel red darken-3" role="usernamemismatchbanner">
                <p class="center-align"><strong class="white-text" >Looks like your password did not match!</strong></p>
                <p class="center-align"><strong class="white-text" >Please try again.</strong></p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <form class="col s12 m12 l12 x12" method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF']);?>">
                ...
                <div class="input-field col s12 m12 l12 xl12">
                    ...
                    <div class="row">
                        <input role="login" id="submitbutton" class="waves-effect brown darken-3 waves-light btn col s6 offset-s3 m6 offset-m3 l4 xl4 offset-xl1 offset-l1" type="submit" name="login" value="login">
