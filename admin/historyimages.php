...
<head>
    ...
    <title>Admin Cofftea Zone image</title>
...
<body>
    ...
    <main>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Cofftea Zone Abouts Image</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            ...
            <div class="col s12 m12 l12 xl12">
                <?php 
                    if (isset($_SESSION['historyerror'])) {
                        echo "<div class=\"row\">\n".
                                "<div class=\"col center-align red darken-3 ss12 m12 l12 xl12\">\n".
                                $_SESSION['historyerror']. "\n".
                                "</div>\n".
                            "</div>\n";
                        $_SESSION['historyerror'] = null;
                    }

                    if (isset($_SESSION['historysuccess'])) {
                        echo "<div class=\"row\">\n".
                                "<div class=\"col center-align green darken-3 s12 m12 l12 xl12\">\n".
                                $_SESSION['historysuccess']. "\n".
                                "</div>\n".
                            "</div>\n";
                ...
                <table class="responsive-table " style="table-layout:fixed">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center-align">Image name</th>
                            ...
                            if (mysqli_num_rows($result) > 0 ) {
                                while($rows = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td class=\"center-align\">\n".
                                            "<img src=\"../".$rows['path']."\" width=\"70px\" height=\"50px\">\n".
                                        "</td>\n";
                                    echo "<td class=\"center-align\">\n".
                                            "<form action=\"edithistoryimage.php\" method=\"post\">\n".
                                                "<input type=\"hidden\" name=\"editid\" value=\"".$rows['id']."\">\n".
                                                "<input type=\"hidden\" name=\"numbering\" value=\"".$counter."\">\n".
                                                "<button type=\"submit\" class=\"btn waves-light waves-effect\" name=\"editimagehistory\">edit</button>\n".
                                            "</form>\n".
                                        "</td>\n";
                                    $counter++;
                                }
            ...
            <div class="col s12 m12 l12 xl12">
                <div class="container">
                    <div class="row">
                        <form action="addhistoryimage.php" method="post" enctype="multipart/form-data" class="col s12 m12 xl12 l12">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12 ">
                                    <input name="historyimgname" autocomplete="off" required id="historyimgname" class="tooltipped center-align" data-delay="50" data-position="top" data-tooltip="<strong class='tooltippedstyle'>Add History image Name!</strong>" maxlength="50" data-length="50">
                                    <label for="historyimgname">Name</label>
                                </div>
                                 <div class="file-field input-field col s12 m12 l12 xl12">
                                    <div class="btn blue-grey darken-4">
                                        <span>Image</span>
                                        <input type="file" autocomplete="off" required name="historyimg">
                                    </div>
                                ...
                                <div class="input-field col l12 m12 xl12 s12">
                                    <div class="row">
                                        <button type="submit" name="historyimgsubmit" class="add col offset-xl4 offset-l4 xl3 l3 m12 s12 btn waves-light waves-effect">Add</button>
                                    </div>
                                </div>
                            </div>   
                        </form>
