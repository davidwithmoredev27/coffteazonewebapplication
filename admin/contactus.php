    ...
    <main>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Contact Us Details</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <?php
            ...
            while ($rows = mysqli_fetch_assoc($result)) {
                $phone1 = $rows['mobileone'];
                $phone2 = $rows['mobiletwo'];
                $address = $rows['address'];
                $email = $rows['email'];
                $telephone = $rows['telephone'];
               //$operatingtime = $rows['operatingtime'];
            }
        ?>
    
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="center-align">Contact Us details</h5>
            </div>
            <div class="container">
                <?php
                    if (isset($_SESSION['contactuserror'])) {
                        echo "<div class='row'>\n".
                                "<div class='center-align red darken-3 col s12 m12 l12 xl12'>\n".
                                $_SESSION['contactuserror'].
                                "</div>\n".
                            "</div>\n";
                    ...
                    if(isset($_SESSION['contactussuccess'])) {
                        echo "<div class='row'>\n".
                                "<div class=' center-align green darken-3 col s12 m12 l12 xl12'>\n".
                                $_SESSION['contactussuccess'].
                                "</div>\n".
                            "</div>\n";
            ...
            <div class="col s12 m12 l12 xl12">
                <div class="row">
                    <form action="editdcontactus.php" method="post" class="col s12 m12 l8  xl8 offset-l2 offset-xl2">
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <textarea class="materialize-textarea" type="text" required maxlength="100" data-length="100" id="address" name="address" id="" maxlength="100" data-length="100"><?php  echo $address;?></textarea>
                                <label for="address">Address</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="text" class="center-align" required id="telephone" maxlength="15" data-length="15" name="telephone" id="telephone" value='<?php  echo $telephone;?>' maxlength="15" data-length="15">
                                <label for="telephone">Telephone</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input class="center-align" required type="text"  data-length="15" maxlength="15" id="mobileone" name="mobileone" value='<?php  echo $phone1;?>' id="" maxlength="15" data-length="15">
                                <label for="mobileone">Mobile 1</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input class="center-align" required type="text" id="mobiletwo" name=" mobiletwo" value='<?php  echo $phone2;?>' id="" maxlength="15" data-length="15">
                                <label for="mobiletwo">Mobile 2</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input class="center-align" type="email" required id="email" name="email" value="<?php echo $email;?>" id="email" maxlength="100" data-length="100">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12 xl12">
                                <div class="row">
                                    <div class="col s12 m12 xl4 l4 offset-l2 offset-xl2">
                                        <div class="row">
                                            <button type="submit" name="contactupdate" class="update btn waves-light waves-effect col s12 s12 m12 l12 xl12">update</button>
                                        </div>
                                    </div>
                                     <div class="col s12 m12 xl4 l4">
                                        <div class="row">
                                            <a class="waves-ligth waves-effect btn col s12 m12 l12 xl12" href="contactus.php">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
