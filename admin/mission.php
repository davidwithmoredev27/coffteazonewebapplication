...
<head>
    ...
    <title>Admin |About mission</title>
                        ...
                        <form action="addmission.php" method="post" class="col s12 m12 xl12 l12">
                            <div class="row">
                                ...
                                <div class="input-field col l12 m12 xl12 s12">
                                    <div class="row">
                                        <button type="submit" name="missionsubmits" class="add col offset-xl4 offset-l4 xl3 l3 m12 s12 btn waves-light waves-effect">Add</button>
                                    </div>
                                </div>
                            </div>   
                        </form>
