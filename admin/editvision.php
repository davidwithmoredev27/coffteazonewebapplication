...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if (isset($_POST['editvisionsubmit'])) {
            ...
            if (isset($_POST['numbering'])) {
                ...
                if (isset($_POST['editid'])) {
                    if (!is_numeric($_POST['editid'])) {
                        $_SESSION['visionerror'] = "<span><strong class=\"white-text\">Invalid Value!</strong></span>\n";
                        header("location:vision.php");die;
                    }
                    $id = sanitizedData($_POST['editid']);
                    $preventSQLinjection = mysqli_real_escape_string($connection , $id);
                    $sql = "SELECT * FROM tbl_about_vision WHERE id = ". $preventSQLinjection;
                    ...
                    $_SESSION['visionerror'] = "<span><strong class=\"white-text\">Empty Value!</strong></span>\n";
                    header("location:vision.php");die;
                }
            }
            
        } elseif (!isset($_POST['editvisionsubmit'])) {
            $_SESSION['visionerror'] = "<span><strong class=\"white-text\">Empty Value!</strong></span>\n";
            header("location:vision.php");die;
        }
    } else {
...
<head>
    ...
    <title>Edit Vision Id <?php echo  $numbering;?></title>
    ...
    <main>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="vision.php" class="breadcrumb">Vision</a>
                            <a href="#!" class="breadcrumb">Edit Vision</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <div class="container">
                    <div class="row">
                        <form action="visioneditconfirm.php" method="post" class="col s12 m12 l12 xl12">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m12 l4 xl4 offset-l1 offset-xl1">
                                    <a href="vision.php" class="btn waves-light waves-effect">Cancel</a>
                                </div>
                            </div> 
                        </form>     
                    </div>
