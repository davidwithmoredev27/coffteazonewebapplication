...
<head>
    ...
    <title>Admin About Us history</title>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Cofftea Zone history</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            ...
            <div class="col s12 m12 l10 xl10 offset-xl1 offset-l1">
                <table class="responsive-table " style="table-layout:fixed">
                    ...
                    <tbody>
                        <?php
                            $sql = "SELECT * FROM tbl_about_history";
                                ...
                                while($rows = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td class=\"center-align\">\n".
                                        "<form action=\"edithistory.php\" method=\"post\">\n".
                                            ...
                                            "<button type=\"submit\" class=\"btn waves-light waves-effect\" name=\"edithistorysubmit\">edit</button>\n".
                                        "</form>\n";
                                    $counter++;
                                }
                            }
            ...
            <div class="col s12 m12 l12 xl12">
                <div class="container">
                    <div class="row">
                        <form action="addhistory.php" method="post" class="col s12 m12 xl12 l12">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 xl12 ">
                                    <input name="name" autocomplete="off" required id="name" class="tooltipped center-align" data-delay="50" data-position="top" data-tooltip="<strong class='tooltippedstyle'>Add History Name!</strong>" maxlength="50" data-length="50">
                                    <label for="name">Name</label>
                                </div>
                                <div class="input-field col s12 m12 l12 xl12">
                                    <textarea name="description" autocomplete="off" required id="description" class="tooltipped materialize-textarea" data-delay="50" data-position="top" data-tooltip="<strong class='tooltippedstyle'>Add Description!</strong>" maxlength="255" data-length="255"></textarea>
                                    <label for="description">Description</label>
                                </div>
                                <div class="input-field col l12 m12 xl12 s12">
                                    <div class="row">
                                        <button type="submit" name="historyinfosubmit" class="add col offset-xl4 offset-l4 xl3 l3 m12 s12 btn waves-light waves-effect">Add</button>
                                    </div>
                                </div>
                            </div>   
                        </form>
