...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if (isset($_POST['editmissionsubmit'])) {

            if (isset($_POST['numbering'])) {
                $numbering = sanitizedData($_POST['numbering']);
                $numbering = mysqli_real_escape_string($connection , $numbering);
                if (isset($_POST['editid'])) {
                    if (!is_numeric($_POST['editid'])) {
                        $_SESSION['missionerrror'] = "<span><strong class=\"white-text\">Invalid Value!</strong></span>\n";
                        header("location:mission.php");die;
                    }
                    $id = sanitizedData($_POST['editid']);
                    $preventSQLinjection = mysqli_real_escape_string($connection , $id);
                    $sql = "SELECT * FROM tbl_about_mission WHERE id = ". $preventSQLinjection;
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($rows = mysqli_fetch_assoc($result)) {
                            ...
                            $_SESSION['olddescription'] = $rows['description'];
                        }
                    
                    }
                } elseif(!isset($_POST['editiid'])) {
                    $_SESSION['missionerror'] = "<span><strong class=\"white-text\">Empty Value!</strong></span>\n";
                    header("location:mission.php");die;
                }
            }
            
        } elseif (!isset($_POST['editmissionsubmit'])) {
            $_SESSION['missionerror'] = "<span><strong class=\"white-text\">Empty Value!</strong></span>\n";
            header("location:mission.php");die;
        }
    } else {
...
<head>
    ...
    <title>Edit Mission Id <?php echo  $numbering;?></title>
    ...
    <main>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="mission.php" class="breadcrumb">Mission</a>
                            <a href="#!" class="breadcrumb">Edit Mission</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <div class="container">
                    <div class="row">
                        <form action="missioneditconfirm.php" method="post" class="col s12 m12 l12 xl12">
                            <div class="row">
                            ...
                            <div class="row">
                                 <div class="input-field col s12 m12 l12 xl12">
                                    <textarea name="editdescriptionconfirm" id="editdescriptionconfirm" class="materialize-textarea"><?php echo $_SESSION['olddescription']; ?></textarea>
                            ...
                            <div class="row">
                                 <div class="input-field col s12 m12 l4 xl4 offset-l2 offset-xl2">
                                    <button type="submit" name="editconfirmsubmit" class="update btn waves-light waves-effect">Update</button>
                                </div>
                                <div class="input-field col s12 m12 l4 xl4 offset-l1 offset-xl1">
                                    <a href="mission.php" class="btn waves-light waves-effect">Cancel</a>
                                </div>
                            </div> 
                        </form>     
                    </div>
