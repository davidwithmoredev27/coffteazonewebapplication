        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col s12 m12 xl12 m12">
                    <h4 class="center-align">KTV FAQ Settings</h4>
                </div>
                <?php 
                ...
                <div class="col s12 m12 l5 xl5 removeslidermobile">
                    <div class="container">
                        <div class="row">
                            <h5 class="col s12 m12 l12 xl12 center-align">Add KTV FAQ</h5>
                        </div>
                        <div class="row">
                            <form class="col s12 m12 l12 xl12" method="POST" action="ktvfaqupload.php">
                                <div class="row">
                ...
                <div class="col s12 m12 l7 xl7 removeslidermobile">
                    <div class="row">
                        <h5 class="col s12 m12 l12 xl12 center-align">KTV FAQ list</h5>
                    </div>
                    <div class="row">
                        <div class="col s12 m12 l12 xl12">
                                    ...
                                    <?php
                                        ...
                                        while($rows = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td class=\center-align\">".
                                                    "<form method=\"POST\" action=\"ktvfaqdelete.php\">".
