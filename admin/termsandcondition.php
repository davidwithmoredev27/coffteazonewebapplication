...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-beta/css/materialize.min.css" media="screen, projection"> -->
...
<body>
    ...
    <main>
                ...
                <nav class="removebreadcrumbsstyle">
                    <div class="nav-wrapper">
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <a href="#!" class="breadcrumb">Terms And Conditions</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            <h4 class="col s12 12 xl12 m12 center-align">KTV Terms And Conditions.</h4>
            <div class="row">
                <div class="col s12 m12 l12 xl12"></div>
                <div class="col s12 m12 l12 xl12"></div>
                <div class="col s12 m12 l12 xl12"></div>
            ...
            <div class="col s12 m12 l12 xl12">
                <!--ktv terms and conditions-->
                <?php
                    if(isset($_SESSION['termsandconditionerror'])) {
                        echo "<div class=\"col s12 m12 xl12 m12\">\n";
                        echo "<p class=\"center-align red darken-3\">".$_SESSION['termsandconditionerror']."</p>\n";
                        echo "</div>\n";
                        $_SESSION['termsandconditionerror'] = null;
                    }

                     if(isset($_SESSION['termsandconditionsuccess'])) {
                        echo "<div class=\"col s12 m12 xl12 m12\">\n";
                        echo "<p class=\"center-align green darken-3\">".$_SESSION['termsandconditionsuccess']."</p>\n";
                        echo "</div>\n";
                        $_SESSION['termsandconditionsuccess'] = null;
                    }
                ...
                <div class="row">
                    <div class="col s12 m12 xl12 l12">
                        ...
                        <div class="row showonmobiletc">
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <h5 class="col s12 m12 l12 xl12 center-align center-align">Room One Terms and conditions</h5>  
                                </div>
                                        ...
                                        <?php
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    $description = $rows['terms_and_conditions'];
                                                    $id = $rows['id'];
                                                    echo "<tr>\n";
                                                    echo "<td class=\"center-align\">". $counter ."</td>\n";
                                                    echo "<td class=\"center-align\">". $description ."</td>\n";
                                                    echo "<td class='center-align'>\n".
                                                            "<form method=\"post\" action='deleteroom1.php'>".
                                                                "<input type='hidden' value='$id' name='roomdelete'>\n".
                                                                "<button type='submit' name='roomdeletesubmit' class='delete btn red darken-3 waves-light waves-effect'>Delete</button>\n".
                                                            "</form>\n";
                                                    echo "</td>";
                                                    echo "</tr>\n";
                                                    $counter++;
                            ...
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <form action="room1.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                                                <input type="text" name="termsandcondition" id="termsandcondition" data-length="150" required maxlength="150">
                                                <label for="termsandcondition">KTV Terms and Condition</label>
                                            </div>
                                                <div class="input-field col s12 m12 l12 xl12">
                                                <button class="add btn waves-light waves-effect col s12 m12 l12 xl12" type="submit" name="termsandconditionsubmit" id="termsandcondition">ADD</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="row showonmobiletc">
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <h5 class="col s12 m12 l12 xl12 center-align center-align">Room two Terms and conditions</h5>  
                                </div>
                                <table class="responsive-table" style="table-layout:fixed" >
                                    <col class="tccol">
                                    <col class="tccol">
                                        ...
                                        <?php
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class=\"center-align\">". $description ."</td>\n";
                                                    echo "<td class='center-align'>\n".
                                                            "<form method=\"post\" action='deleteroom2.php'>".
                                                                "<input type='hidden' value='$id' name='roomdelete'>\n".
                                                                "<button type='submit' name='roomdeletesubmit' class='delete btn red darken-3 waves-light waves-effect'>Delete</button>\n".
                                                            "</form>\n";
                                                    echo "</td>";
                            ...
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <form action="room2.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                                                <input type="text" name="termsandcondition" id="termsandcondition" data-length="150" required maxlength="150">
                        ...
                        <div class="row showonmobiletc">
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <h5 class="col s12 m12 l12 xl12 center-align center-align">Room three Terms and conditions</h5>  
                                </div>
                                <table class="responsive-table" style="table-layout:fixed" >
                                    <col class="tccol">
                                    <col class="tccol">
                                        ...
                                        <?php
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class=\"center-align\">". $description ."</td>\n";
                                                    echo "<td class='center-align'>\n".
                                                            "<form method=\"post\" action='deleteroom3.php'>".
                                                                "<input type='hidden' value='$id' name='roomdelete'>\n".
                                                                "<button type='submit' name='roomdeletesubmit' class='delete btn red darken-3 waves-light waves-effect'>Delete</button>\n".
                                                            "</form>\n";
                                                    echo "</td>";
                            ...
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <form action="room3.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                                                <input type="text" name="termsandcondition" id="termsandcondition" data-length="150" required maxlength="150">
                                                <label for="termsandcondition">Terms and Condition</label>
                        ...
                        <div class="row showondekstoptc">
                            ...
                            <div class="col s12 m12 l4 xl4">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12">
                                        <h5 class="center-align">Room 1</h5>
                                    </div>
                                    <form action="room1.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                        ...
                        <div class="row showondekstoptc">
                            ...
                            <div class="col s12 m12 l4 xl4">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12">
                                        <h5 class="center-align">Room 2</h5>
                                    </div>
                                    <form action="room2.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                        ...
                        <div class="row showondekstoptc">
                            ...
                            <div class="col s12 m12 l4 xl4">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12">
                                        <h5 class="center-align">Room 3</h5>
                                    </div>
                                    <form action="room3.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
            ...
            <h4 class="col s12 12 xl12 m12 center-align">Martinas Terms And Conditions.</h4>
            <div class="row">
                <div class="col s12 m12 l12 xl12"></div>
                <div class="col s12 m12 l12 xl12"></div>
                <div class="col s12 m12 l12 xl12"></div>
                <div class="col s12 m12 l12 xl12"></div>
                        ...
                        <div class="row showonmobiletc">
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <h5 class="col s12 m12 l12 xl12 center-align center-align">Package one Terms and conditions</h5>  
                                </div>
                                <table class="responsive-table" style="table-layout:fixed" >
                                    <col class="tccol">
                                    <col class="tccol">
                                        ...
                                        <?php
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class=\"center-align\">". $description ."</td>\n";
                                                    echo "<td class='center-align'>\n".
                                                            "<form method=\"post\" action='deletepackageone.php'>".
                                                                "<input type='hidden' value='$id' name='roomdelete'>\n".
                                                                "<button type='submit' name='roomdeletesubmit' class='delete btn red darken-3 waves-light waves-effect'>Delete</button>\n".
                                                            "</form>\n";
                                                    echo "</td>";
                            ...
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <form action="packageone.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                                                <input type="text" name="termsandcondition" id="termsandcondition" data-length="150" required maxlength="150">
                                                <label for="termsandcondition">Terms and Condition</label>
                        ...
                        <div class="row showonmobiletc">
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <h5 class="col s12 m12 l12 xl12 center-align center-align">Package two Terms and conditions</h5>  
                                </div>
                                <table class="responsive-table" style="table-layout:fixed" >
                                    <col class="tccol">
                                    <col class="tccol">
                                        ...
                                        <?php
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($rows = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class=\"center-align\">". $description ."</td>\n";
                                                    echo "<td class='center-align'>\n".
                                                            "<form method=\"post\" action='deletepackagetwo.php'>".
                                                                "<input type='hidden' value='$id' name='roomdelete'>\n".
                                                                "<button type='submit' name='roomdeletesubmit' class='delete btn red darken-3 waves-light waves-effect'>Delete</button>\n".
                                                            "</form>\n";
                                                    echo "</td>";
                            ...
                            <div class="col s12 m12 l12 xl12">
                                <div class="row">
                                    <form action="packagetwo.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                                                <input type="text" name="termsandcondition" id="termsandcondition" data-length="150" required maxlength="150">
                                                <label for="termsandcondition">Terms and Condition</label>
                        ...
                        <div class="row showondekstoptc">
                            ...
                            <div class="col s12 m12 l4 xl4">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12">
                                        <h5 class="center-align">package 1</h5>
                                    </div>
                                    <form action="packageone.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
                        ...
                        <div class="row showondekstoptc">
                            ...
                            <div class="col s12 m12 l4 xl4">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12 xl12">
                                        <h5 class="center-align">Package 2</h5>
                                    </div>
                                    <form action="packagetwo.php" method="POST" class="col s12 m12 xl12 l12">
                                        <div class="row">
                                            <div class="input-field col s12 m12 l12 xl12">
