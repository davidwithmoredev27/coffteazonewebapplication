...
<?php
    ...
    if (isset($_POST['addaccount'])) {
        ...
        if (isset($_POST['securitypin'])) {
            if (is_numeric($_POST['securitypin'])) {
            ...
            } else if (!is_numeric($_POST['securitypin'])) {
...
<body>
    ...
    <div class="container">
        ...
        <div class="row loginimg" role="coffteazonelogo">
            <div class="col l3 offset-l5 m3 offset-m5 xl3 offset-xl5 s5 offset-s5 ">
                <img src="../img/logo/cofftealogo.png"  width="130px" height="130px" alt="coffteazone logo">
            </div>
        </div>
        <?php
        ...
        <form class="col s12 m12 l12 xl12" method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF']);?>">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l12 xl12">
                    ...
                    <button role="addaccount" id="addsubmit" class="waves-effect brown darken-3 waves-light btn col s6 offset-s3 m6 offset-m3 l3 xl3 offset-l2 offset-xl2" type="submit" name="addaccount">Register</button>
